...
if(NOT ANTLR_JAR_FILE)
    find_program(ANTLR_JAR_FILE
            NAMES antlr.jar antlr4.jar antlr-4.jar antlr-4.8-complete.jar)
endif()

if(ANTLR_JAR_FILE AND Java_JAVA_EXECUTABLE)
    execute_process(
            COMMAND ${Java_JAVA_EXECUTABLE} -jar ${ANTLR_JAR_FILE}
...
endif(ANTLR_JAR_FILE AND Java_JAVA_EXECUTABLE)

include(FindPackageHandleStandardArgs)

find_package_handle_standard_args(
        Antlr4
        REQUIRED_VARS ANTLR_JAR_FILE Java_JAVA_EXECUTABLE
